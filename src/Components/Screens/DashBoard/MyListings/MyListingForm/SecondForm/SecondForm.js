  ...
  return (
    <div className="my-listing-second-form">
        ...
        <div className="grid-2 mt-2">
                ...
                <h5 className="feature-title mt-2">Property Features</h5>
                ...
                <div className="property-form">
                    ...
                    <label for="scales" className='form-check-label'>Scales</label>
                    </div>
                ...
                <div className="grid-1">
                    ...
                    className='form-check-label'>Horns</label>
                    </div>
                </div>
                </div>
                ...
                <div className="grid-1">
                <h5 class="feature-title mt-2">Property Amenities</h5>
                </div>
