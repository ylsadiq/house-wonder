                    ...
                    <div className="my-listing-map">
                        ...
                        {/* {formStep >= 1 ? <div className={formStep === 1 ? 'd-block': 'd-none'}> */}
                            ...
                            <div className="grid-1">
                                <div class="form-floating">
                                    <div class="form-floation mb-4 mt-2">
                                        <input onBlur={(e) => setPropertyHeader(e.target.value)} type="text" name="property_header" class="form-control" id='propHeader' placeholder="Property Header (Hint: Type your properties tittle here)" />
                           ...
                           {check && <div className='grid-1'>
                                <div class="form-floation mb-4 mt-2">
                                    <input onChange={(e) => handleAvailable(e)} type="date" placeholder="Select Aailable Date" class="form-control" name="video_url" id="video_url" />
                            ...
                            <div className="grid-2 mt-2">
                                <div class="form-floation">
                                    <div class="form-floation mb-4 mt-2">
                                        <input onChange={(e) => setPropertyFlat(e.target.value)} type="text" name="property_header" class="form-control" id='flat' placeholder="flat" />
                                ...
                                <div class="form-floation">
                                    <div class="form-floation mb-4 mt-2">
                                        <input onChange={(e) => setPropertyHouse(e.target.value)} type="text" name="property_header" class="form-control" id='house' placeholder="house" />
                            ...
                            <div className="grid-2 mt-2">
                                <div class="form-floation">
                                    <div class="form-floation mb-4 mt-2">
                                        <input onChange={(e) => setPropertyRoad(e.target.value)} type="text" name="property_header" class="form-control" id='road' placeholder="road" />
                                ...
                                <div class="form-floation">
                                    <div class="form-floation mb-4 mt-2">
                                        <input onChange={(e) => setPropertyTotalFlat(e.target.value)} type="text" name="property_header" class="form-control" id='totalFloor' placeholder="totalFloor" />
                            ...
                            <div className="grid-2 mt-2">
                                <div class="form-floation">
                                    <div class="form-floation mb-4 mt-2">
                                        <input onChange={(e) => setContactPersonFlat(e.target.value)} type="text" name="property_header" class="form-control" id='yourFloor' placeholder="yourFloor" />
                            ...
                            <div className="ratio-box">
                                ...
                                <div className="auth-form">
                                    <div className="auth-form-input">
                                        <input onChange={(e) => setContactWithMe(e.target.value)} type="radio" id="contactWithMe" name="mylisting4" value="contactWithMe" />
                                        <label htmlFor="contactWithMe">Contact With Me</label>
                                    </div>

                                    <div className="auth-form-input">
                                        <input onChange={(e) => setContactPersonName(e.target.value)} type="radio" id="assignPerson" name="mylisting4" value="availableFrom" />
